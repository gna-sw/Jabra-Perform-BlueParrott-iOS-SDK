...
/*!
 * Set/get whether the SDK should send anonymous analytics to BlueParrott/GN.
 * Analytics allow us to improve the product and assist with development issues.
 * Defaults to NO.
 */
@property (class) BOOL sendAnalytics;
